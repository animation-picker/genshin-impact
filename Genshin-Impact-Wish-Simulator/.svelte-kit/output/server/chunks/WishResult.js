import { q as assign, i as is_function, c as create_ssr_component, a as subscribe, d as add_attribute, e as escape, v as validate_component, m as missing_component, k as each, j as null_to_empty, g as getContext, s as setContext } from "./index.js";
...
const css$7 = {
  code: ".character.duplicate.svelte-1ahii34.svelte-1ahii34{animation:svelte-1ahii34-brighten forwards 1s;animation-delay:1s}.item.svelte-1ahii34.svelte-1ahii34{transition:all 0.2s;will-change:transform}.item.svelte-1ahii34.svelte-1ahii34:hover,.item.hover.svelte-1ahii34.svelte-1ahii34{transform:scale(1.04)}.item.svelte-1ahii34:hover .cover.svelte-1ahii34,.item.hover.svelte-1ahii34 .cover.svelte-1ahii34{background-color:rgba(0, 0, 0, 0)}.star5.svelte-1ahii34 .item-body.svelte-1ahii34{background-image:linear-gradient(\n			to bottom,\n			rgb(249, 170, 2),\n			rgb(255, 255, 255),\n			rgb(249, 170, 2)\n		)}.star4.svelte-1ahii34 .item-body.svelte-1ahii34{background-image:linear-gradient(\n			to bottom,\n			rgb(196, 77, 218),\n			rgb(255, 255, 255),\n			rgb(196, 77, 218)\n		)}.new.svelte-1ahii34.svelte-1ahii34{position:absolute;z-index:10;display:block;top:3%;left:80%;transform:translateX(-50%);padding:0 0.4rem;border-radius:calc(2 / 100 * var(--card-height)) 0;color:#fffa66;background-color:#c3882a;border:1px solid #fffa66;font-size:calc(3 / 100 * var(--card-height))}.cover.svelte-1ahii34.svelte-1ahii34{display:block;position:absolute;left:0;top:0;height:100%;width:100%;transition:all 0.2s;background-color:rgba(0, 0, 0, 0.2)}.item-body.svelte-1ahii34.svelte-1ahii34{--scale:2.05;height:100%;-webkit-clip-path:url(#wishframe);clip-path:url(#wishframe);margin:0 0.5px;display:flex;justify-content:center;align-items:center;touch-action:unset;background-image:linear-gradient(to bottom, #aac8f1, #fff, #aac8f1)}.item-body.catalyst.svelte-1ahii34.svelte-1ahii34{--scale:1.3}.character.svelte-1ahii34 .item-body.svelte-1ahii34{--scale:5;--translate-y:150%}.item-content.svelte-1ahii34.svelte-1ahii34{-webkit-clip-path:url(#wishframe);clip-path:url(#wishframe);transform:scaleX(0.98) scaleY(0.99);background-image:var(--bg);background-size:cover;background-position:center center;position:relative}.item-content.svelte-1ahii34.svelte-1ahii34::after{content:'';display:block;position:absolute;bottom:0;left:0;width:100%;height:50%}#chinese-char.svelte-1ahii34.svelte-1ahii34{font-family:'AaQiShu';position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);font-size:15vh;filter:drop-shadow(0.2rem 0.2rem 0.02rem rgb(0, 0, 0));writing-mode:vertical-lr}.zoomist-image.svelte-1ahii34.svelte-1ahii34{position:absolute;transform:translate(var(--translate-x, 0px), var(--translate-y, 0px)) scale(var(--scale, 0))}.zoomist-image.weapon.svelte-1ahii34.svelte-1ahii34{width:100%;height:100%}img.svelte-1ahii34.svelte-1ahii34{width:100%;height:100%;display:block;-o-object-fit:contain;object-fit:contain;-o-object-position:center;object-position:center}.weapon.svelte-1ahii34 img.wishpic.svelte-1ahii34{filter:drop-shadow(0.2rem 0.2rem 0.02rem rgb(0, 0, 0))}.stella.svelte-1ahii34.svelte-1ahii34{margin-top:10%}.stella.svelte-1ahii34.svelte-1ahii34,.masterless.svelte-1ahii34.svelte-1ahii34{width:60%;border-radius:10%;overflow:hidden;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1;position:relative;box-shadow:0 0 7px rgba(255, 255, 255, 0.7), 0 0 14px rgba(255, 255, 255, 0.5),\n			0 0 21px rgba(255, 255, 255, 0.2), 0 0 42px rgba(255, 255, 255, 1)}.stella.svelte-1ahii34.svelte-1ahii34::after,.masterless.svelte-1ahii34 span.svelte-1ahii34{width:100%;font-size:calc(3 / 100 * var(--card-height));content:'1';display:block;position:absolute;left:0;bottom:0;color:#fff;text-align:center;background-color:rgba(0, 0, 0, 0.5)}.stella5.svelte-1ahii34.svelte-1ahii34,.starglitter.svelte-1ahii34.svelte-1ahii34{background-image:linear-gradient(to top, #ca8937, #a47853)}.stella4.svelte-1ahii34.svelte-1ahii34{background-image:linear-gradient(to top, #a47ab9, #7e78a9)}.info.svelte-1ahii34.svelte-1ahii34{position:absolute;bottom:10%;left:0;width:100%;z-index:10;display:flex;flex-direction:column;align-items:center}.info.svelte-1ahii34 .gi-star.svelte-1ahii34{color:#f7cf33;display:inline-block;font-size:calc(3.5 / 100 * var(--card-height))}.icon.svelte-1ahii34 svg{width:80%;aspect-ratio:1/1}@keyframes svelte-1ahii34-brighten{0%{filter:brightness(100%)}50%{filter:brightness(150%)}100%{filter:brightness(100%)}}.rainbow.svelte-1ahii34.svelte-1ahii34{color:#fff;animation:svelte-1ahii34-animate 1.5s linear infinite;text-shadow:0 0 50px #0072ff, 0 0 100px #0072ff, 0 0 150px #0072ff, 0 0 200px #0072ff;filter:hue-rotate(0deg);animation-delay:0.1s}@keyframes svelte-1ahii34-animate{from{filter:hue-rotate(0deg)}to{filter:hue-rotate(360deg)}}.flux.svelte-1ahii34.svelte-1ahii34{animation:svelte-1ahii34-flux 1.5s linear infinite;-moz-animation:svelte-1ahii34-flux 1.5s linear infinite;-webkit-animation:svelte-1ahii34-flux 1.5s linear infinite;-o-animation:svelte-1ahii34-flux 1.5s linear infinite}@keyframes svelte-1ahii34-flux{0%,100%{text-shadow:0 0 1vw #1041FF, 0 0 3vw #1041FF, 0 0 10vw #1041FF, 0 0 10vw #1041FF, 0 0 .4vw #8BFDFE, .5vw .5vw .1vw #147280;color:#28D7FE}50%{text-shadow:0 0 .5vw #082180, 0 0 1.5vw #082180, 0 0 5vw #082180, 0 0 5vw #082180, 0 0 .2vw #082180, .5vw .5vw .1vw #0A3940;color:#146C80}}",
  map: null
};
const Result_list_item = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div id="${"wish" + escape(index, true)}" class="${[
    "item star" + escape(rarity, true) + " " + escape(type, true) + " svelte-1ahii34",
    !isNew ? "duplicate" : ""
  ].join(" ").trim()}">${isNew ? `<div class="${"new svelte-1ahii34"}">${escape($t("wish.result.new"))}</div>` : ``}
	<div class="${"zoomist-container item-body " + escape(weaponType || "", true) + " svelte-1ahii34"}"><div class="${"zoomist-wrapper item-content svelte-1ahii34"}" style="${"--bg: url(" + escape($assets["resultcard-bg.webp"], true) + ")"}">${custom ? (() => {
    let { images = {}, hostedImages = {}, status, artPosition } = $customData || {}, { artURL } = status === "owned" ? images : hostedImages, { wishCard = {} } = artPosition || {};
    return `
				
				
				<div class="${"zoomist-image svelte-1ahii34"}"${add_attribute("style", getCssVarPosition(wishCard, clientHeight, clientWidth), 0)}><img${add_attribute("src", artURL, 0)}${add_attribute("alt", name, 0)} class="${"wishpic svelte-1ahii34"}" crossorigin="${"anonymous"}"></div>`;
  })() : `${type === "member" ? `<p id="${"chinese-char"}" class="${escape(null_to_empty(rarity === 5 ? "rainbow" : rarity === 4 ? "flux" : ""), true) + " svelte-1ahii34"}">${escape(chineseChar)}</p>
				
				

				` : `${type === "weapon" ? `<div class="${"zoomist-image weapon svelte-1ahii34"}"><img${add_attribute("src", $assets[name], 0)}${add_attribute("alt", name, 0)} class="${"wishpic svelte-1ahii34"}" crossorigin="${"anonymous"}"></div>

				` : `<div class="${"zoomist-image svelte-1ahii34"}"${add_attribute("style", getCssVarPosition(offset?.wishCard || {}, clientHeight, clientWidth), 0)}><img${add_attribute("src", $assets[`splash-art/${useOutfit ? outfitName : name}`], 0)}${add_attribute("alt", name, 0)} class="${"wishpic svelte-1ahii34"}" crossorigin="${"anonymous"}"></div>`}`}`}

			<div class="${"info svelte-1ahii34"}"><div class="${"icon svelte-1ahii34"}" style="${"width: 100%;"}">${isNew || type === "weapon" ? (() => {
    ...
    return `<div class="${"i gi-star svelte-1ahii34"}"></div>`;
  })}</div>` : ``}

				${type === "character" && !isNew ? `<div class="${"masterless " + escape(bonusType, true) + " svelte-1ahii34"}">${validate_component(Icon, "Icon").$$render($$result, { type: bonusType, width: "80%" }, {}, {})}
						<span class="${"svelte-1ahii34"}">${escape(bonusQty)}</span></div>` : ``}

				${stelaFortuna ? `<div class="${"stella stella" + escape(rarity, true) + " svelte-1ahii34"}"><img${add_attribute("src", $assets[`stella-fortuna-${rarity}star.webp`], 0)} alt="${"Stella Fortuna"}" class="${"svelte-1ahii34"}"></div>` : ``}</div>

			${type === "character" && !isNew ? `<div class="${"cover svelte-1ahii34"}"></div>` : ``}</div></div>
</div>`;
});
...
const css$1 = {
  code: ".zoomist-wrapper.svelte-kmgez0.svelte-kmgez0,.zoomist-image.svelte-kmgez0.svelte-kmgez0{width:100%;height:100%;display:flex;justify-content:center;align-items:center}.zoomist-wrapper.svelte-kmgez0.svelte-kmgez0{--scale:1.5;--translate-x:0px;--translate-y:0px;background-color:unset;position:relative}.zoomist-wrapper.weapon.svelte-kmgez0.svelte-kmgez0{--scale:1.1}.zoomist-image.svelte-kmgez0.svelte-kmgez0{transform:translate(var(--translate-x, 0px), var(--translate-y, 0px)) scale(var(--scale, 0))}#chinese-char.svelte-kmgez0.svelte-kmgez0{font-family:'AaQiShu';position:absolute;top:50%;left:45%;transform:translate(-50%, -50%);font-size:20vh;width:10%;word-wrap:break-word;line-height:85%;filter:drop-shadow(0.2rem 0.2rem 0.02rem rgb(0, 0, 0))}img.svelte-kmgez0.svelte-kmgez0{width:100%;height:100%;display:block;-o-object-fit:contain;object-fit:contain;-o-object-position:center;object-position:center}.splash-art.anim.svelte-kmgez0.svelte-kmgez0{filter:brightness(0) opacity(0);animation:svelte-kmgez0-splashart forwards 1.5s 1}.splash-art.svelte-kmgez0.svelte-kmgez0:not(.anim){transform:translate(2%, 0)}.zoomist-image.svelte-kmgez0.svelte-kmgez0{position:relative;width:var(--width);height:var(--height)}.splash-art.svelte-kmgez0 .weapon img.svelte-kmgez0{position:absolute;top:50%;left:50%;transform:translate(-50%, -50%)}.splash-art.svelte-kmgez0 .weapon img.weaponbg.svelte-kmgez0{height:80%}.splash-art.svelte-kmgez0 .weapon.anim img.weaponbg.svelte-kmgez0{opacity:0;animation:svelte-kmgez0-weaponbg forwards 1.5s 1}.bow-parent.svelte-kmgez0 .weaponbg.svelte-kmgez0{transform:translate(-53%, -50%) scale(1.1) !important}.catalyst-parent.svelte-kmgez0 .weaponbg.svelte-kmgez0{height:90% !important}.anim.svelte-kmgez0 .bow.svelte-kmgez0,.anim.svelte-kmgez0 .polearm.svelte-kmgez0,.anim.svelte-kmgez0 .sword.svelte-kmgez0,.anim.svelte-kmgez0 .claymore.svelte-kmgez0,.anim.svelte-kmgez0 .catalyst.svelte-kmgez0{animation:svelte-kmgez0-weaponShadow forwards 0.1s 1;animation-delay:1.2s;filter:drop-shadow(0 0 0 rgba(0, 0, 0, 0))}.bow.svelte-kmgez0.svelte-kmgez0,.polearm.svelte-kmgez0.svelte-kmgez0,.sword.svelte-kmgez0.svelte-kmgez0,.claymore.svelte-kmgez0.svelte-kmgez0,.catalyst.svelte-kmgez0.svelte-kmgez0{filter:drop-shadow(0.6rem 0.6rem 0.05rem rgb(0, 0, 0))}.bow.svelte-kmgez0.svelte-kmgez0{height:115%}.catalyst.svelte-kmgez0.svelte-kmgez0{height:40%}.polearm.svelte-kmgez0.svelte-kmgez0{transform:translate(-53%, -35%) scale(1.2) !important}@keyframes svelte-kmgez0-splashart{0%{transform:scale(5) translate(0, -5%);filter:brightness(0)}20%{transform:scale(1);filter:brightness(0)}75%{transform:scale(1);filter:brightness(0)}95%{transform:scale(1) translate(2%, 0);filter:brightness(1)}100%{transform:scale(1) translate(2%, 0);filter:brightness(1)}}@keyframes svelte-kmgez0-weaponbg{80%{opacity:0}85%{opacity:1}100%{opacity:1}}@keyframes svelte-kmgez0-weaponShadow{to{filter:drop-shadow(0.7rem 0.6rem 0.2rem rgba(0, 0, 0, 0.7))}}.rainbow.svelte-kmgez0.svelte-kmgez0{color:#fff;animation:svelte-kmgez0-animate 1.5s linear infinite;text-shadow:0 0 50px #0072ff, 0 0 100px #0072ff, 0 0 150px #0072ff, 0 0 200px #0072ff;filter:hue-rotate(0deg);animation-delay:0.1s}@keyframes svelte-kmgez0-animate{from{filter:hue-rotate(0deg)}to{filter:hue-rotate(360deg)}}.flux.svelte-kmgez0.svelte-kmgez0{color:#426DFB;text-shadow:0 0 3vw #2356FF;animation:svelte-kmgez0-flux 2s linear infinite;-moz-animation:svelte-kmgez0-flux 2s linear infinite;-webkit-animation:svelte-kmgez0-flux 2s linear infinite;-o-animation:svelte-kmgez0-flux 2s linear infinite}@keyframes svelte-kmgez0-flux{0%,100%{text-shadow:0 0 1vw #1041FF, 0 0 3vw #1041FF, 0 0 10vw #1041FF, 0 0 10vw #1041FF, 0 0 .4vw #8BFDFE, .5vw .5vw .1vw #147280;color:#28D7FE}50%{text-shadow:0 0 .5vw #082180, 0 0 1.5vw #082180, 0 0 5vw #082180, 0 0 5vw #082180, 0 0 .2vw #082180, .5vw .5vw .1vw #0A3940;color:#146C80}}",
  map: null
};
const Splash_art = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_customData();
  $$unsubscribe_assets();
  return `<div class="${"zoomist-wrapper splash-art anim " + escape(type, true) + " svelte-kmgez0"}" style="${"overflow: visible;"}">
	${custom ? (() => {
    let { images = {}, hostedImages = {}, status, artPosition } = $customData || {}, { splashArt = {} } = artPosition || {};
    return `
		
		
		<div class="${"zoomist-image svelte-kmgez0"}"${add_attribute("style", getCssVarPosition(splashArt, clientHeight, clientWidth), 0)}><img${add_attribute("alt", name, 0)} crossorigin="${"anonymous"}" class="${"svelte-kmgez0"}"></div>

		`;
  })() : `${type === "weapon" ? `<div class="${"zoomist-image weapon anim " + escape(weaponType, true) + "-parent svelte-kmgez0"}"><img${add_attribute("src", $assets[`bg-${weaponType}.webp`], 0)}${add_attribute("alt", weaponType, 0)} class="${"weaponbg svelte-kmgez0"}">
			<img${add_attribute("alt", name, 0)} class="${escape(null_to_empty(weaponType), true) + " svelte-kmgez0"}"></div>` : `${type === "member" ? `<div class="${"zoomist-image weapon anim " + escape(weaponType, true) + "-parent svelte-kmgez0"}"><img${add_attribute("src", $assets[`bg-${weaponType}.webp`], 0)}${add_attribute("alt", weaponType, 0)} class="${"weaponbg svelte-kmgez0"}">
			<p id="${"chinese-char"}" class="${escape(null_to_empty(rarity === 5 ? "rainbow" : rarity === 4 ? "flux" : ""), true) + " svelte-kmgez0"}">${escape(chineseChar)}</p></div>` : `${type === "outfit" ? `<div class="${"zoomist-image svelte-kmgez0"}"${add_attribute("style", getCssVarPosition(offset, clientHeight, clientWidth), 0)}><img${add_attribute("alt", name, 0)} crossorigin="${"anonymous"}" class="${"svelte-kmgez0"}"></div>` : `<div class="${"zoomist-image svelte-kmgez0"}"${add_attribute("style", getCssVarPosition(offset, clientHeight, clientWidth), 0)}><img${add_attribute("alt", name, 0)} crossorigin="${"anonymous"}" class="${"svelte-kmgez0"}"></div>`}`}`}`}
</div>`;
});
