...
${$$result.head += `<meta name="${"description"}"${add_attribute("content", DESCRIPTION, 0)} data-svelte="svelte-ow42yk"><meta name="${"keywords"}"${add_attribute("content", KEYWORDS, 0)} data-svelte="svelte-ow42yk"><meta property="${"al:web:url"}"${add_attribute("content", HOST, 0)} data-svelte="svelte-ow42yk"><link rel="${"fluid-icon"}" href="${escape(HOST, true) + "/meta-picture.jpg"}"${add_attribute("title", APP_TITLE, 0)} data-svelte="svelte-ow42yk"><meta property="${"og:url"}"${add_attribute("content", HOST, 0)} data-svelte="svelte-ow42yk"><meta property="${"og:type"}" content="${"website"}" data-svelte="svelte-ow42yk"><meta property="${"og:title"}"${add_attribute("content", APP_TITLE, 0)} data-svelte="svelte-ow42yk"><meta property="${"og:description"}"${add_attribute("content", DESCRIPTION, 0)} data-svelte="svelte-ow42yk"><meta property="${"og:image"}" content="${escape(HOST, true) + "/meta-picture.jpg"}" data-svelte="svelte-ow42yk"><meta name="${"twitter:card"}" content="${"summary_large_image"}" data-svelte="svelte-ow42yk"><meta property="${"twitter:domain"}"${add_attribute("content", HOST.replace("https://", "").replace("http://", ""), 0)} data-svelte="svelte-ow42yk"><meta property="${"twitter:url"}"${add_attribute("content", HOST, 0)} data-svelte="svelte-ow42yk"><meta name="${"twitter:title"}"${add_attribute("content", APP_TITLE, 0)} data-svelte="svelte-ow42yk"><meta name="${"twitter:description"}"${add_attribute("content", DESCRIPTION, 0)} data-svelte="svelte-ow42yk"><meta name="${"twitter:image"}" content="${escape(HOST, true) + "/meta-picture.jpg"}" data-svelte="svelte-ow42yk"><link rel="${"preload"}" href="${"/fonts/aaqishu.woff"}" as="${"font"}" type="${"font/woff"}" crossorigin data-svelte="svelte-ow42yk"><link rel="${"preload"}" href="${"/fonts/optimized_global_web.woff2"}" as="${"font"}" type="${"font/woff2"}" crossorigin data-svelte="svelte-ow42yk"><link rel="${"preload"}" href="${"/fonts/optimized_th_web.woff2"}" as="${"font"}" type="${"font/woff2"}" crossorigin data-svelte="svelte-ow42yk"><link rel="${"preload"}" href="${"/fonts/optimized_jp_web.woff2"}" as="${"font"}" type="${"font/woff2"}" crossorigin data-svelte="svelte-ow42yk"><link rel="${"preload"}" href="${"/fonts/optimized_zh_web.woff2"}" as="${"font"}" type="${"font/woff2"}" crossorigin data-svelte="svelte-ow42yk">${`<link rel="${"manifest"}" href="${"/appmanifest.json"}" data-svelte="svelte-ow42yk">`}`, ""}
